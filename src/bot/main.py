...
WELCOME_MESSAGE = """👋 Здравствуйте! Я AI-помощник сети «Евроопт».

Просто напишите свой вопрос в свободной форме — расскажу про карту Еплюс, акции e-доставки, рецепты, магазины Евроопт в Минске и контакты компании.

Примеры:
• «Как оформить карту Еплюс?»
• «Какие сейчас акции?»
