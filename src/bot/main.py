...
WELCOME_MESSAGE = """👋 Здравствуйте! Я AI-ассистент сети «Евроторг» — магазинов «Евроопт», «Грошык» и «Хит».

Напишите свой вопрос в свободной форме — расскажу про акции, карту «Еплюс», магазины, рецепты и игру «Удача в придачу».

Например:
• «Что в текущей листовке Красная цена?»
• «Скидки на мясо / молочку / овощи»
• «Призы в текущем туре "Удачи в придачу"»
• «Как получить карту Еплюс?»
• «Магазины Евроопт в Минске»
• «Что такое Родныя тавары / СВАЁ?»"""
