...
INTENT_KEYWORDS: dict[Intent, list[str]] = {
    ...
    Intent.STORES: [
        ...
        # Запросы про услуги/инфраструктуру внутри магазинов
        "есть ли в евроопт", "в евроопте на", "в евроопте есть",
        "аптека", "кафетерий", "банкомат в", "сколько магазин",
        "форматы магазин",
    ],
    Intent.DELIVERY: [
    ...
    Intent.SMALLTALK: [
        ...
        "как дела", "как ты",
        # Самоопределение бота
        "ты кто", "кто ты", "ты бот", "ты человек", "ты ИИ",
        "ты искусственный", "что ты можешь", "что ты умеешь",
        "представься", "ты что",
    ],
}
