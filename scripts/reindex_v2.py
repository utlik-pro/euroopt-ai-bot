...
def load_listovka_current():
    ...
    CAT_RULES = [
        ...
        ("рыба_морепродукты", ["рыб", "сельд", "лосос", "форел", "семг", "тунец", "треск", "минта", "скумбри", "креветк", "икр", "крабов"],
         "рыба, морепродукты, акции на рыбу, скидки на рыбу, икра, креветки, селедка, рыбные консервы"),
        ("бакалея", ["мука", "сахар", "соль ", "масл", "уксус", "сод", "разрыхл", "ванил", "приправ", "специ", "соус", "майонез", "горчиц"],
         "бакалея, скидки на бакалею, мука, сахар, масло, специи, соусы, приправы"),
        ("замороженное", ["заморож", "пельмен", "вареник", "блинчик", "котлет", "хинкал", "манты", "лед "],
         "замороженные продукты, скидки на пельмени, вареники, заморозка, замороженное"),
        ("снеки", ["чипс", "сухар", "орех", "арахис", "семечк", "кокос", "попкорн", "крекер", "галет"],
         "снеки, чипсы, орехи, акции на снеки, скидки на чипсы и орехи"),
        ("бытхимия_гигиена", ["мыло", "шампун", "паст", "стиральн", "порошок", "гель", "ополаск", "кондицион", "губк", "салфетк", "ватн", "пасту"],
         "бытовая химия, скидки на бытовую химию, средства гигиены, мыло, шампунь, стиральный порошок"),
        ("корма", ["корм", "сухой корм", "влажн.корм", "лоток"],
         "корма для животных, скидки на корм для собак и кошек"),
    ]
